...
public class OrderServiceImpl implements OrderService{
    ...
    public OrderSubmitVO submit(OrdersSubmitDTO ordersSubmitDTO){
        ...
        orderDetailMapper.insertBatch(oderDetailList);
        //清空购物车
    ...
    public PageResult pageQueryUser(int page, int pageSize, Integer status){
        ...
        Page<Orders> pageResult = orderMapper.page(ordersPageQueryDTO);
    ...
    public void repetition(Long id){
        //根据订单id查询订单
        Long userId = BaseContext.getCurrentId();
        List<OrderDetail> orderDetails = orderDetailMapper.getById(userId);
